...
if __name__ == '__main__':
    origin_fsfeature_csvpth = "/home/yxpt/Desktop/Projects/H_PDN_new/Files/DatasetFeatureTable_T1.csv"
    selected_subj_csvpth = './Files/AgeGender_dropWJHMDD_combine.csv'
    save_fs_csvpth = './Files/SMHC_fsfeature.csv'
