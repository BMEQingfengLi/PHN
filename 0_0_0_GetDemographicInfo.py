...
def GetDemographicCSV(csvfold_pth, demographic_csv_savepth):
    ...
    # hc_gender_age_eduage_list = GetDemographicRow(hc_idxlist, gender_group_np, age_group_np, eduage_group_np)
    # bd_gender_age_eduage_list = GetDemographicRow(bd_idxlist, gender_group_np, age_group_np, eduage_group_np)
    # mdd_gender_age_eduage_list = GetDemographicRow(mdd_idxlist, gender_group_np, age_group_np, eduage_group_np)
    # sz_gender_age_eduage_list = GetDemographicRow(sz_idxlist, gender_group_np, age_group_np, eduage_group_np)
    # ocd_gender_age_eduage_list = GetDemographicRow(ocd_idxlist, gender_group_np, age_group_np, eduage_group_np)
    ...
    # eduage_row = ['Education age (Mean\u00B1Std)',
    #               hc_gender_age_eduage_list[2],
    #               bd_gender_age_eduage_list[2],
    #               mdd_gender_age_eduage_list[2],
    #               sz_gender_age_eduage_list[2],
    #               ocd_gender_age_eduage_list[2],
    #               spearmanr(eduage_group_np, label_group_np)[0],
    #               spearmanr(eduage_group_np, label_group_np)[1]]
    # csv_writer.writerow(eduage_row)
    new_csv.close()


if __name__ == '__main__':
    csvfold_pth = './Files/HBN_MDDAndHC_T1available.csv'
    demographic_csv_savepth = './SaveFile/HBN_Demographic.csv'
